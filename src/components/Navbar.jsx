...
const Navbar = () => {
  return (
    ...
    >
      <div className="w-[100%] md:w-[80%] flex justify-between  items-center">
        <div className="w-fit md:w-[20%] flex justify-start">
          <Image
            src="/logo.svg"
            alt="logo"
            width={100}
        ...
        <div className="md:flex hidden w-[40%] relative text-xl helvetica text-[#8A3E1D] justify-evenly">
          <div
            style={{
