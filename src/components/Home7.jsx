        ...
        >
            <div className="flex flex-col gap-10 items-center w-[100%] h-full">
                <div className="flex flex-col gap-2 w-full">
                    <ScrollReveal direction="right" distance={30} duration={0.7} delay={0.2}>
                        <div className="text-[#FF0000] text-center md:text-right text-xl inter font-medium w-full">
                            Testimonials
                        </div>
                    </ScrollReveal>
                    <ScrollReveal direction="right" distance={40} duration={0.8} delay={0.3}>
                ...
                <div className="w-full justify-center grid grid-row-3 md:grid-cols-3 items-center gap-5 relative h-full ">
                    <ScrollReveal direction="left" distance={40} duration={0.7} delay={0.4}>
                        <Image
                            src="/c1.svg"
                            alt="home3"
                            width={400}
                    ...
                    <ScrollReveal direction="up" distance={40} duration={0.7} delay={0.5}>
                        <Image
                            src="/c2.svg"
                            alt="hme3"
                            width={400}
                    ...
                    <ScrollReveal direction="right" distance={40} duration={0.7} delay={0.6}>
                        <Image
                            src="/c3.svg"
                            alt="home3"
                            width={400}
