            ...
            <div className="flex flex-col gap-10 w-[90%] md:w-[80%]">
                ...
                >
                    ...
                    <ScrollReveal direction="left" distance={30} duration={0.8} delay={0.3} className="w-full lg:w-1/2">
                        <div className="bg-[#FFF9F0] rounded-xl flex flex-col shadow-sm h-full" style={{ gap: "clamp(1rem,1vw,100rem)", padding: 'clamp(1rem, 4vw, 2rem)' }}>
                            <h2 className="text-2xl md:text-4xl pixel text-[#8A3E1D] mb-6">GET IN TOUCH</h2>
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    <div className=" p-3 rounded-full">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#EB8B23]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <ScrollReveal direction="right" distance={30} duration={0.8} delay={0.4} className="w-full lg:w-1/2">
                        <div className="bg-[#FFF9F0] flex flex-col rounded-xl shadow-sm" style={{ padding: 'clamp(1rem, 4vw, 2rem)',             gap: "clamp(1rem,1vw,100rem)" }}>
                            <h2 className="text-2xl md:text-4xl pixel text-[#8A3E1D] mb-6">SEND US A MESSAGE</h2>
                    ...
                    gap: "clamp(1rem,1vw,100rem)"
                            ...
                            >
                                <div>
                                    <label htmlFor="name" className="block text-[#8A3E1D] mb-2 inter "
                                       style={{
                    marginBottom: "clamp(0.5rem,0.75vw,100rem)"
                }}>Your Name</label>
                                    <input 
                                        type="text" 
                                        id="name" 
                    ...
                    padding: "clamp(0.5rem,0.75vw,100rem)"
                                        ...
                                        className="w-full  rounded-lg border border-[#EB8B23] focus:outline-none focus:ring-2 focus:ring-[#8A3E1D]" 
                                        required 
                                    />
                                </div>
                                
                                <div>
                                    <label htmlFor="email" className="block text-[#8A3E1D] mb-2 inter "
                                    style={{
                    marginBottom: "clamp(0.5rem,0.75vw,100rem)"
                }}
                    ...
                    padding: "clamp(0.5rem,0.75vw,100rem)"
                                ...
                                <div>
                                    <label htmlFor="phone" className="block text-[#8A3E1D] mb-2 inter "
                                       style={{
                    marginBottom: "clamp(0.5rem,0.75vw,100rem)"
                }}>Phone Number</label>
                                    <input 
                    ...
                    padding: "clamp(0.5rem,0.75vw,100rem)"
                                ...
                                <div>
                                    <label htmlFor="message" className="block text-[#8A3E1D] mb-2 inter "
                                       style={{
                    marginBottom: "clamp(0.5rem,0.75vw,100rem)"
                }}>Your Message</label>
                                    <textarea 
                    ...
                    padding: "clamp(0.5rem,0.75vw,100rem)"
                                ...
                                <button 
                                    ...
                                    className=" text-[#fff]  rounded-lg bg-[#8A3E1D] transition-colors duration-300 pixel text-lg"
                                >
                                    Send Message
                                </button>
                            </form>
